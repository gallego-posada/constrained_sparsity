...
# Config lists
declare -a seeds=(1)
declare -a target_densities=(0.01 0.05 0.1 0.2)
declare -a lmbdas=()
declare -a reg_types=("model")
...
yaml_arg="-yaml ${L0_SRC_PATH}/configs/defaults/tiny_imagenet_unstructured.yml"
